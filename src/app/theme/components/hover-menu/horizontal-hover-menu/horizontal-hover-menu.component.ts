...
@Component({
  selector: 'app-horizontal-hover-menu',
  templateUrl: './horizontal-hover-menu.component.html',
  styleUrls: ['./horizontal-hover-menu.component.scss']
})
export class HorizontalHoverMenuComponent implements OnInit {
