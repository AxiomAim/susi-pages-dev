...
@Component({
  selector: 'app-susi-support-selection-guides',
  templateUrl: './susi-support-selection-guides.component.html',
  styleUrls: ['./susi-support-selection-guides.component.scss']
})
export class SusiSupportSelectionGuidesComponent implements OnInit {
  public sub: any;
  public supportId: any = 'susiadaptors.com';
  public supportCategory: any = 'selectionGuides';
  public support: SUSISupportDto = SUSISupportModel.emptyDto();
  public selectionGuides: any;
  ...
  ngOnInit(): void {
    ...
    this.sub = this.activatedRoute.params.subscribe(params => {
      ...
      this.susiSupportDataService.getOne(this.supportId).pipe(tap(res => {
        this.support = res;
        this.selectionGuides = this.support.selectionGuides;
      })).subscribe();
    });
  ...
  remove(selectionGuides): void {
    ...
    dialogRef.afterClosed().subscribe(dialogResult => {
      if (dialogResult) {
        this.support.selectionGuides = this.support.selectionGuides.filter(obj => obj !== selectionGuides);
  ...
  drop(event: CdkDragDrop<string[]>) {
    moveItemInArray(this.support.selectionGuides, event.previousIndex, event.currentIndex);
