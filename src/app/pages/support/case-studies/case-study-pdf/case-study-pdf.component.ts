...
@Component({
  selector: 'app-case-study-pdf',
  templateUrl: './case-study-pdf.component.html',
  styleUrls: ['./case-study-pdf.component.scss']
})
export class CaseStudyPdfComponent implements OnInit {
  private sub: any;
  public src: any;
