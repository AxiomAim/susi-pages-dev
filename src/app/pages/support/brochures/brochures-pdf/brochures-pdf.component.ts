...
@Component({
  selector: 'app-brochures-pdf',
  templateUrl: './brochures-pdf.component.html',
  styleUrls: ['./brochures-pdf.component.scss']
})
export class BrochuresPdfComponent implements OnInit {
  private sub: any;
  public src: any;
